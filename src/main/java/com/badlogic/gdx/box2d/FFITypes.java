...
*/
    /*JNI
		...
		static_assert(sizeof(b2ContactBeginTouchEvent) == 124, "Type b2ContactBeginTouchEvent has unexpected size.");
		...
		static_assert(sizeof(b2ContactData) == 124, "Type b2ContactData has unexpected size.");
		...
		static_assert(sizeof(b2Manifold) == 108, "Type b2Manifold has unexpected size.");
		static_assert(alignof(b2Manifold) == 4, "Type b2Manifold has unexpected alignment.");
		static_assert(offsetof(b2Manifold, points) == 0, "Type b2Manifold has unexpected offset.");
		static_assert(offsetof(b2Manifold, normal) == 96, "Type b2Manifold has unexpected offset.");
		static_assert(offsetof(b2Manifold, pointCount) == 104, "Type b2Manifold has unexpected offset.");
		static_assert(sizeof(b2ShapeCastInput) == 84, "Type b2ShapeCastInput has unexpected size.");
		static_assert(alignof(b2ShapeCastInput) == 4, "Type b2ShapeCastInput has unexpected alignment.");
		static_assert(offsetof(b2ShapeCastInput, points) == 0, "Type b2ShapeCastInput has unexpected offset.");
		static_assert(offsetof(b2ShapeCastInput, count) == 64, "Type b2ShapeCastInput has unexpected offset.");
		static_assert(offsetof(b2ShapeCastInput, radius) == 68, "Type b2ShapeCastInput has unexpected offset.");
		...
		static_assert(sizeof(b2RevoluteJointDef) == 88, "Type b2RevoluteJointDef has unexpected size.");
		...
		static_assert(offsetof(b2RevoluteJointDef, enableSpring) == 36, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, hertz) == 40, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, dampingRatio) == 44, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, enableLimit) == 48, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, lowerAngle) == 52, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, upperAngle) == 56, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, enableMotor) == 60, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, maxMotorTorque) == 64, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, motorSpeed) == 68, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, drawSize) == 72, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, collideConnected) == 76, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, userData) == 80, "Type b2RevoluteJointDef has unexpected offset.");
		static_assert(offsetof(b2RevoluteJointDef, internalValue) == 84, "Type b2RevoluteJointDef has unexpected offset.");
		...
		static_assert(sizeof(b2NullJointDef) == 24, "Type b2NullJointDef has unexpected size.");
		static_assert(alignof(b2NullJointDef) == 4, "Type b2NullJointDef has unexpected alignment.");
		static_assert(offsetof(b2NullJointDef, bodyIdA) == 0, "Type b2NullJointDef has unexpected offset.");
		static_assert(offsetof(b2NullJointDef, bodyIdB) == 8, "Type b2NullJointDef has unexpected offset.");
		static_assert(offsetof(b2NullJointDef, userData) == 16, "Type b2NullJointDef has unexpected offset.");
		static_assert(offsetof(b2NullJointDef, internalValue) == 20, "Type b2NullJointDef has unexpected offset.");
		...
		static_assert(offsetof(b2ShapeDef, friction) == 4, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, restitution) == 8, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, rollingResistance) == 12, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, density) == 16, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, filter) == 24, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, customColor) == 48, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, isSensor) == 52, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, enableContactEvents) == 53, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, enableHitEvents) == 54, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, enablePreSolveEvents) == 55, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, invokeContactCreation) == 56, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, updateBodyMass) == 57, "Type b2ShapeDef has unexpected offset.");
		...
		static_assert(sizeof(b2WorldDef) == 76, "Type b2WorldDef has unexpected size.");
		...
		static_assert(offsetof(b2WorldDef, contactPushMaxSpeed) == 24, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, jointHertz) == 28, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, jointDampingRatio) == 32, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, maximumLinearSpeed) == 36, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, frictionMixingRule) == 40, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, restitutionMixingRule) == 44, "Type b2WorldDef has unexpected offset.");
		...
		static_assert(offsetof(b2WorldDef, finishTask) == 60, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, userTaskContext) == 64, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, userData) == 68, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, internalValue) == 72, "Type b2WorldDef has unexpected offset.");
		...
		static_assert(offsetof(b2ManifoldPoint, maxNormalImpulse) == 36, "Type b2ManifoldPoint has unexpected offset.");
		...
		static_assert(sizeof(b2ChainDef) == 64, "Type b2ChainDef has unexpected size.");
		...
		static_assert(offsetof(b2ChainDef, friction) == 12, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, restitution) == 16, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, filter) == 24, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, customColor) == 48, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, isLoop) == 52, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, enableSensorEvents) == 53, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, internalValue) == 56, "Type b2ChainDef has unexpected offset.");
		...
		static_assert(sizeof(b2PrismaticJointDef) == 92, "Type b2PrismaticJointDef has unexpected size.");
		...
		static_assert(offsetof(b2PrismaticJointDef, enableSpring) == 44, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, hertz) == 48, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, dampingRatio) == 52, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, enableLimit) == 56, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, lowerTranslation) == 60, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, upperTranslation) == 64, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, enableMotor) == 68, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, maxMotorForce) == 72, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, motorSpeed) == 76, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, collideConnected) == 80, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, userData) == 84, "Type b2PrismaticJointDef has unexpected offset.");
		static_assert(offsetof(b2PrismaticJointDef, internalValue) == 88, "Type b2PrismaticJointDef has unexpected offset.");
		...
		static_assert(sizeof(b2DistanceOutput) == 28, "Type b2DistanceOutput has unexpected size.");
		...
		static_assert(offsetof(b2DistanceOutput, distance) == 16, "Type b2DistanceOutput has unexpected offset.");
		static_assert(offsetof(b2DistanceOutput, iterations) == 20, "Type b2DistanceOutput has unexpected offset.");
		static_assert(offsetof(b2DistanceOutput, simplexCount) == 24, "Type b2DistanceOutput has unexpected offset.");
		...
		static_assert(sizeof(b2ShapeCastPairInput) == 188, "Type b2ShapeCastPairInput has unexpected size.");
		...
		static_assert(sizeof(b2DebugDraw) == 68, "Type b2DebugDraw has unexpected size.");
		static_assert(alignof(b2DebugDraw) == 4, "Type b2DebugDraw has unexpected alignment.");
		static_assert(offsetof(b2DebugDraw, DrawPolygon) == 0, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSolidPolygon) == 4, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawCircle) == 8, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSolidCircle) == 12, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSolidCapsule) == 16, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSegment) == 20, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawTransform) == 24, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawPoint) == 28, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawString) == 32, "Type b2DebugDraw has unexpected offset.");
		...
		static_assert(offsetof(b2DebugDraw, drawAABBs) == 56, "Type b2DebugDraw has unexpected offset.");
		...
		static_assert(offsetof(b2DebugDraw, drawFrictionImpulses) == 63, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, context) == 64, "Type b2DebugDraw has unexpected offset.");
		...
		static_assert(offsetof(b2ShapeCastInput, translation) == 72, "Type b2ShapeCastInput has unexpected offset.");
		static_assert(offsetof(b2ShapeCastInput, maxFraction) == 80, "Type b2ShapeCastInput has unexpected offset.");
		static_assert(sizeof(b2RevoluteJointDef) == 96, "Type b2RevoluteJointDef has unexpected size.");
		...
		static_assert(offsetof(b2Capsule, center2) == 8, "Type b2Capsule has unexpected offset.");
		static_assert(offsetof(b2Capsule, radius) == 16, "Type b2Capsule has unexpected offset.");
		static_assert(sizeof(b2NullJointDef) == 32, "Type b2NullJointDef has unexpected size.");
		static_assert(alignof(b2NullJointDef) == 8, "Type b2NullJointDef has unexpected alignment.");
		static_assert(offsetof(b2NullJointDef, bodyIdA) == 0, "Type b2NullJointDef has unexpected offset.");
		static_assert(offsetof(b2NullJointDef, bodyIdB) == 8, "Type b2NullJointDef has unexpected offset.");
		static_assert(offsetof(b2NullJointDef, userData) == 16, "Type b2NullJointDef has unexpected offset.");
		static_assert(offsetof(b2NullJointDef, internalValue) == 24, "Type b2NullJointDef has unexpected offset.");
		static_assert(sizeof(b2Transform) == 16, "Type b2Transform has unexpected size.");
		static_assert(alignof(b2Transform) == 4, "Type b2Transform has unexpected alignment.");
		static_assert(offsetof(b2Transform, p) == 0, "Type b2Transform has unexpected offset.");
		static_assert(offsetof(b2Transform, q) == 8, "Type b2Transform has unexpected offset.");
		...
		static_assert(alignof(b2ShapeDef) == 8, "Type b2ShapeDef has unexpected alignment.");
		static_assert(offsetof(b2ShapeDef, userData) == 0, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, friction) == 8, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, restitution) == 12, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, rollingResistance) == 16, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, density) == 20, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, filter) == 24, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, customColor) == 48, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, isSensor) == 52, "Type b2ShapeDef has unexpected offset.");
		static_assert(offsetof(b2ShapeDef, enableContactEvents) == 53, "Type b2ShapeDef has unexpected offset.");
		...
		static_assert(offsetof(b2ChainDef, friction) == 20, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, restitution) == 24, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, filter) == 32, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, customColor) == 56, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, isLoop) == 60, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, enableSensorEvents) == 61, "Type b2ChainDef has unexpected offset.");
		static_assert(offsetof(b2ChainDef, internalValue) == 64, "Type b2ChainDef has unexpected offset.");
		...
		static_assert(offsetof(b2DebugDraw, DrawPolygon) == 0, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSolidPolygon) == 8, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawCircle) == 16, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSolidCircle) == 24, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSolidCapsule) == 32, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawSegment) == 40, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawTransform) == 48, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawPoint) == 56, "Type b2DebugDraw has unexpected offset.");
		static_assert(offsetof(b2DebugDraw, DrawString) == 64, "Type b2DebugDraw has unexpected offset.");
		...
		static_assert(offsetof(b2DebugDraw, drawAABBs) == 92, "Type b2DebugDraw has unexpected offset.");
		...
		static_assert(offsetof(b2DebugDraw, drawFrictionImpulses) == 99, "Type b2DebugDraw has unexpected offset.");
...
switch(id) {
	...
	case 76:
		...
		nativeType->fields[7] = getNativeType(3);
		nativeType->fields[8] = getNativeType(3);
		nativeType->fields[9] = getNativeType(10);
		nativeType->fields[10] = getNativeType(10);
		nativeType->fields[11] = getNativeType(0);
		nativeType->fields[12] = getNativeType(0);
		nativeType->fields[13] = getNativeType(4);
