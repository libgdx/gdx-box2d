...
*/
    /*JNI
		...
		static_assert(offsetof(b2PlaneSolverResult, position) == 0, "Type b2PlaneSolverResult has unexpected offset.");
		...
		static_assert(offsetof(b2WorldDef, frictionCallback) == 40, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, restitutionCallback) == 44, "Type b2WorldDef has unexpected offset.");
		...
		static_assert(sizeof(b2PlaneResult) == 16, "Type b2PlaneResult has unexpected size.");
		...
		static_assert(offsetof(b2PlaneResult, hit) == 12, "Type b2PlaneResult has unexpected offset.");
		...
		static_assert(offsetof(b2Polygon, radius) == 136, "Type b2Polygon has unexpected offset.");
		static_assert(offsetof(b2Polygon, count) == 140, "Type b2Polygon has unexpected offset.");
		static_assert(sizeof(b2WorldDef) == 104, "Type b2WorldDef has unexpected size.");
		...
		static_assert(offsetof(b2WorldDef, maximumLinearSpeed) == 36, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, frictionCallback) == 40, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, restitutionCallback) == 48, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, enableSleep) == 56, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, enableContinuous) == 57, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, workerCount) == 60, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, enqueueTask) == 64, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, finishTask) == 72, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, userTaskContext) == 80, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, userData) == 88, "Type b2WorldDef has unexpected offset.");
		static_assert(offsetof(b2WorldDef, internalValue) == 96, "Type b2WorldDef has unexpected offset.");
		static_assert(sizeof(b2ManifoldPoint) == 48, "Type b2ManifoldPoint has unexpected size.");
		static_assert(alignof(b2ManifoldPoint) == 4, "Type b2ManifoldPoint has unexpected alignment.");
		static_assert(offsetof(b2ManifoldPoint, point) == 0, "Type b2ManifoldPoint has unexpected offset.");
		static_assert(offsetof(b2ManifoldPoint, anchorA) == 8, "Type b2ManifoldPoint has unexpected offset.");
