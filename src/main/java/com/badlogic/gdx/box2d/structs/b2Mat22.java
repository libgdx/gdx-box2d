...
public final class b2Mat22 extends com.badlogic.gdx.jnigen.runtime.pointer.Struct {
    ...
    private static final int __cy_offset = CHandler.getOffsetForField(__ffi_type, 0);
