...
switch(id) {
	...
	case 4:
		...
		return nativeType;
	case 5:
		GET_NATIVE_TYPE(int16_t, nativeType);
		return nativeType;
	case 6:
	...
	case 11:
		...
		return nativeType;
	case 12:
		GET_NATIVE_TYPE(unsigned long long, nativeType);
		return nativeType;
	case 13:
		...
		nativeType->fields[1] = getNativeType(71);
		return nativeType;
	case 14:
		nativeType->type = STRUCT_TYPE;
		...
		nativeType->fields[17] = getNativeType(6);
		return nativeType;
	case 15:
		nativeType->type = STRUCT_TYPE;
		nativeType->field_count = 2;
	...
	case 17:
		...
		nativeType->fields[1] = getNativeType(16);
	...
	case 28:
		...
		nativeType->fields[9] = getNativeType(6);
		nativeType->fields[10] = getNativeType(6);
		nativeType->fields[11] = getNativeType(6);
		nativeType->fields[12] = getNativeType(6);
		nativeType->fields[13] = getNativeType(6);
		nativeType->fields[14] = getNativeType(6);
		nativeType->fields[15] = getNativeType(6);
		nativeType->fields[16] = getNativeType(6);
		nativeType->fields[17] = getNativeType(6);
		nativeType->fields[18] = getNativeType(6);
		nativeType->fields[19] = getNativeType(6);
		nativeType->fields[20] = getNativeType(6);
		nativeType->fields[21] = getNativeType(6);
		nativeType->fields[22] = getNativeType(6);
		return nativeType;
	case 29:
		nativeType->type = STRUCT_TYPE;
		nativeType->field_count = 23;
	...
	case 31:
		...
		nativeType->field_count = 5;
		nativeType->fields = (native_type**)malloc(sizeof(native_type*) * 5);
		nativeType->fields[0] = getNativeType(34);
		nativeType->fields[1] = getNativeType(34);
	...
	case 34:
		...
		nativeType->fields[2] = getNativeType(71);
		nativeType->fields[3] = getNativeType(71);
		nativeType->fields[4] = getNativeType(71);
		nativeType->fields[5] = getNativeType(71);
		nativeType->fields[6] = getNativeType(71);
		nativeType->fields[7] = getNativeType(71);
		nativeType->fields[8] = getNativeType(6);
		nativeType->fields[9] = getNativeType(3);
		return nativeType;
	case 35:
	...
	case 40:
		...
		nativeType->fields[6] = getNativeType(3);
		nativeType->fields[7] = getNativeType(3);
		nativeType->fields[8] = getNativeType(8);
	...
	case 45:
		...
		nativeType->fields[6] = getNativeType(71);
		nativeType->fields[7] = getNativeType(71);
		nativeType->fields[8] = getNativeType(71);
		nativeType->fields[9] = getNativeType(71);
		nativeType->fields[10] = getNativeType(71);
		nativeType->fields[11] = getNativeType(71);
		nativeType->fields[12] = getNativeType(71);
		nativeType->fields[13] = getNativeType(71);
		nativeType->fields[14] = getNativeType(71);
		nativeType->fields[15] = getNativeType(71);
		nativeType->fields[16] = getNativeType(71);
	...
	case 60:
		...
		nativeType->fields[2] = getNativeType(3);
		nativeType->fields[3] = getNativeType(3);
		nativeType->fields[4] = getNativeType(36);
	...
	case 62:
		...
		nativeType->fields[2] = getNativeType(63);
		nativeType->fields[3] = getNativeType(6);
		return nativeType;
	case 63:
		nativeType->type = STRUCT_TYPE;
...
*/
    ...
    */
    ...
    static {
        ...
        ffiIdMap.put(5, CHandler.constructCTypeFromNativeType("int16_t", getNativeType(5)));
        CHandler.registerCType(ffiIdMap.get(5));
        ffiIdMap.put(6, CHandler.constructCTypeFromNativeType("int32_t", getNativeType(6)));
        CHandler.registerCType(ffiIdMap.get(6));
        ffiIdMap.put(7, CHandler.constructCTypeFromNativeType("int64_t", getNativeType(7)));
        CHandler.registerCType(ffiIdMap.get(7));
        ffiIdMap.put(8, CHandler.constructCTypeFromNativeType("uint16_t", getNativeType(8)));
        CHandler.registerCType(ffiIdMap.get(8));
        ffiIdMap.put(9, CHandler.constructCTypeFromNativeType("uint32_t", getNativeType(9)));
        ...
        ffiIdMap.put(12, CHandler.constructCTypeFromNativeType("unsigned long long", getNativeType(12)));
